...
def summarize(name: str, results: list) -> dict:
    ...
    # Step distribution for successful episodes
    if successes:
...
if __name__ == "__main__":
    ...
    # RQ3: Ordering analysis on RL agent sequences
    # (Only RL has meaningful learned sequences; other baselines are fixed/random)
    print("\n" + "=" * 60)
    print(" RQ3 — Ordering Analysis on RL Agent (Baseline Evaluation)")
    print("=" * 60)
    # run_rl results already contain "sequence" field
